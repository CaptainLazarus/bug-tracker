    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                projectId = req.params.projectId;
                _b = (0, validators_1.createBugValidator)(title, description, priority), errors = _b.errors, valid = _b.valid;
                if (!valid) {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                _c = (0, validators_1.createBugValidator)(title, description, priority), errors = _c.errors, valid = _c.valid;
                if (!valid) {
                    return [2 /*return*/, res.status(400).send({ message: Object.values(errors)[0] })];
                }
                return [4 /*yield*/, Member_1.Member.find({ projectId: projectId })];
