        ...
        switch (_b.label) {
            case 0:
                ...
                memberIds = req.body.members
                    ? __spreadArray([req.user], req.body.members, true)
                    : [req.user];
                _a = (0, validators_1.createProjectValidator)(name, memberIds), errors = _a.errors, valid = _a.valid;
                if (!valid) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                nameValidationError = (0, validators_1.projectNameError)(name);
