...
var Bug = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Project_1.Project; }, function (project) { return project; }),
    ...
    __decorate([
        (0, typeorm_1.OneToMany)(function () { return Note_1.Note; }, function (note) { return note.bug; }),
